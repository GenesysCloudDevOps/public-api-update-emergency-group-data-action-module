A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Update Emergency Group
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-update-emergency-group-data-action-module.git?ref=main"
    action_name        = "Update Emergency Group"
